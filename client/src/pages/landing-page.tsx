...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-primary to-primary/80 text-white py-16 px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <ol className="space-y-4 text-gray-700">
                ...
                <li className="flex gap-3">
                  <span className="bg-primary text-white rounded-full h-6 w-6 flex items-center justify-center flex-shrink-0">2</span>
                  <span>Faça check-in selecionando direção (ida/retorno)</span>
                </li>
                <li className="flex gap-3">
                  <span className="bg-primary text-white rounded-full h-6 w-6 flex items-center justify-center flex-shrink-0">3</span>
                  <span>Para viagens de retorno, escolha o horário desejado</span>
                </li>
                <li className="flex gap-3">
                  <span className="bg-primary text-white rounded-full h-6 w-6 flex items-center justify-center flex-shrink-0">4</span>
